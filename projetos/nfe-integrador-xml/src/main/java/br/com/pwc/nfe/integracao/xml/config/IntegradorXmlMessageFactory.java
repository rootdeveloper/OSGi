...
public class IntegradorXmlMessageFactory {
	
	private static final Logger LOGGER = Logger.getLogger(IntegradorXmlMessageFactory.class);
	...
	public void init() {
		...
		bundle = ResourceBundle.getBundle("mensagensIntegradorXmlNFe");
	}
